...
Source0  : https://files.pythonhosted.org/packages/2f/15/222b423b0b88689c266d9eac4e61396fe2cc53464459d6a37618ac863b24/markdown-3.8.tar.gz
...
%prep
%setup -q -n markdown-3.8
cd %{_builddir}/markdown-3.8
pushd ..
cp -a markdown-3.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744391705
