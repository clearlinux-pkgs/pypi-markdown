...
Source0  : https://files.pythonhosted.org/packages/d7/c2/4ab49206c17f75cb08d6311171f2d65798988db4360c4d1485bd0eedd67c/markdown-3.8.2.tar.gz
...
%prep
%setup -q -n markdown-3.8.2
cd %{_builddir}/markdown-3.8.2
pushd ..
cp -a markdown-3.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750430036
...
cp %{_builddir}/markdown-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/pypi-markdown/10a6161d9a071f024bccaf30851e633b7a071049 || :
...
/usr/share/package-licenses/pypi-markdown/10a6161d9a071f024bccaf30851e633b7a071049
