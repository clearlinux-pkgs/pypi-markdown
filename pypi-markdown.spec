...
Source0  : https://files.pythonhosted.org/packages/54/28/3af612670f82f4c056911fbbbb42760255801b3068c48de792d354ff4472/markdown-3.7.tar.gz
...
%prep
%setup -q -n markdown-3.7
cd %{_builddir}/markdown-3.7
pushd ..
cp -a markdown-3.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724083809
