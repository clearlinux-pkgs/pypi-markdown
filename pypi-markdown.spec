...
Source0  : https://files.pythonhosted.org/packages/11/28/c5441a6642681d92de56063fa7984df56f783d3f1eba518dc3e7a253b606/Markdown-3.5.2.tar.gz
...
%prep
%setup -q -n Markdown-3.5.2
cd %{_builddir}/Markdown-3.5.2
pushd ..
cp -a Markdown-3.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704923700
